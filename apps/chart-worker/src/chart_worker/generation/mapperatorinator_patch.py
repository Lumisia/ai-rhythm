...
REQUIRED_GAMEPLAY_INTERVAL_V35_PATCH_ID = (
    "required-gameplay-interval-v35-origin-accounting"
)
REQUIRED_GAMEPLAY_ENFORCEMENT_V36_PATCH_ID = (
    "required-gameplay-enforcement-v36-shadow-fsm"
)
INTRO_EVIDENCE_V37_PATCH_ID = "intro-evidence-v37-region-class"
CONSTRAINT_PATCH_ID = (
    ...
    f"{REQUIRED_GAMEPLAY_INTERVAL_V35_PATCH_ID}+"
    f"{REQUIRED_GAMEPLAY_ENFORCEMENT_V36_PATCH_ID}+"
    f"{INTRO_EVIDENCE_V37_PATCH_ID}"
)
...
REQUIRED_GAMEPLAY_INTERVAL_V35_PATCH_PATH = (
    PATCH_DIR / "mapperatorinator-v32-required-gameplay-interval-v35.patch"
)
REQUIRED_GAMEPLAY_ENFORCEMENT_V36_PATCH_PATH = (
    PATCH_DIR / "mapperatorinator-v32-required-gameplay-enforcement-v36.patch"
)
INTRO_EVIDENCE_V37_PATCH_PATH = (
    PATCH_DIR / "mapperatorinator-v32-intro-evidence-v37.patch"
)
...
REQUIRED_PATCHES = (
    ...
    (INTRO_EVIDENCE_V37_PATCH_ID, INTRO_EVIDENCE_V37_PATCH_PATH),
)
LEGACY_V36_REQUIRED_PATCHES = REQUIRED_PATCHES[:-1]
LEGACY_V35_REQUIRED_PATCHES = LEGACY_V36_REQUIRED_PATCHES[:-1]
LEGACY_V34_REQUIRED_PATCHES = LEGACY_V35_REQUIRED_PATCHES[:-1]
LEGACY_V33_REQUIRED_PATCHES = LEGACY_V34_REQUIRED_PATCHES[:-1]
...
LEGACY_REQUIRED_PATCH_SETS = (
    LEGACY_V36_REQUIRED_PATCHES,
    LEGACY_V35_REQUIRED_PATCHES,
    LEGACY_V34_REQUIRED_PATCHES,
